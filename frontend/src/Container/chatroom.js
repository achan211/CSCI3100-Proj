    ...
    <div>
      ...
      <div className="container mx-auto" style={{ marginTop: "-128px" }}>
        <div className="py-6 h-screen">
          <div className="flex border border-gray-500 rounded shadow-lg h-full">
            {/* Left */}
            <div className="w-1/3 border flex flex-col">
              ...
              <div className="bg-gray-200 flex-1 overflow-auto">
                <div className="px-3 flex items-center bg-gray-400 cursor-pointer">
                  ...
                  <div className="ml-4 flex-1 border-b border-gray-200 py-4">
                    <div className="flex items-bottom justify-between">
                      <p className="text-gray-900">New Movie! Expendables 4</p>
                      <p className="text-xs text-gray-900">12:45 pm</p>
                    </div>
                ...
                <div className="bg-white px-3 flex items-center hover:bg-gray-200 cursor-pointer">
                  ...
                  <div className="ml-4 flex-1 border-b border-gray-200 py-4">
                    <div className="flex items-bottom justify-between">
                      <p className="text-gray-900">Arnold Schwarzenegger</p>
                      <p className="text-xs text-gray-900">12:45 pm</p>
                    </div>
                ...
                <div className="bg-white px-3 flex items-center hover:bg-gray-200 cursor-pointer">
                  ...
                  <div className="ml-4 flex-1 border-b border-gray-200 py-4">
                    <div className="flex items-bottom justify-between">
                      <p className="text-gray-900">Russell Crowe</p>
                      <p className="text-xs text-gray-900">12:45 pm</p>
                    </div>
                    <p className="text-gray-700 mt-1 text-sm">Hold the line!</p>
                  </div>
                </div>
                <div className="bg-white px-3 flex items-center hover:bg-gray-200 cursor-pointer">
                  <div>
                  ...
                  <div className="ml-4 flex-1 border-b border-gray-200 py-4">
                    <div className="flex items-bottom justify-between">
                      <p className="text-gray-900">Tom Cruise</p>
                      <p className="text-xs text-gray-900">12:45 pm</p>
                    </div>
                    <p className="text-gray-700 mt-1 text-sm">
                      Show me the money!
                ...
                <div className="bg-white px-3 flex items-center hover:bg-gray-200 cursor-pointer">
                  ...
                  <div className="ml-4 flex-1 border-b border-gray-200 py-4">
                    <div className="flex items-bottom justify-between">
                      <p className="text-gray-900">Harrison Ford</p>
                      <p className="text-xs text-gray-900">12:45 pm</p>
                    </div>
                    <p className="text-gray-700 mt-1 text-sm">
              ...
              >
                <div className="py-2 px-3">
                  ...
                  <div className="flex justify-center mb-4">
                    ...
                    >
                      <p className="text-xs">
                        Messages to this chat and calls are now secured-500 with
                  ...
                  <div className="flex mb-2">
                    <div
                      ...
                      style={{ backgroundColor: "#F2F2F2" }}
                    >
                      <p className="text-sm text-purple-500">Tom Cruise</p>
                      <p className="text-sm mt-1">
                  ...
                  <div className="flex mb-2">
                    <div
                      ...
                      style={{ backgroundColor: "#F2F2F2" }}
                    >
                      <p className="text-sm text-orange-500">Harrison Ford</p>
